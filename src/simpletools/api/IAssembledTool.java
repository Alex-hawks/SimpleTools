...
public interface IAssembledTool extends IAdditionalMeterData
{
    /**
     * @param attachment
     *            The attachment for the tool
     * @param core
     *            The Core for the tool
     * @param storage
     *            The Storage, such as a battery, for the tool
    ...
    /**
     * @param assembledTool
     *            The assembled tool for which the core is wanted
     * @return The ItemStack of the associated core. stackSize of 1, MUST BE
     *         CORRECT TIER!
     */
     ...
     * @return The ItemStack of the Storage (eg. Battery). MUST be created
     *         storing the amount of primary energy that was stored in the
     *         assembled tool
     */
    ...
    /**
     * @param assembledTool
     *            The Assembled Tool for which the condition is wanted
     ...
     *            The Assembled Tool for which the condition is wanted
     * @param entity
     *            the entity breaking the block, can usually be cast to an
     *            EntityPlayer, but make sure to check
