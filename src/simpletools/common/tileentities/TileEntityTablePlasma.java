...
public class TileEntityTablePlasma extends TileEntityElectrical 
implements IRedstoneProvider, IPacketReceiver, IInventory, IElectricityStorage
{
	/**
	 * 		0:	Battery
	 * </br>1:	Tool
	 * </br>2:	Deuterium AND/OR Tritium
	 * </br>3:	Empty Cells
	 */
	...
	public void updateEntity()
	{
		...
		else if (this.joules >= JOULES_PER_OPERATION && this.deuterium > 0 && this.plasma + PLASMA_PER_DEUTERIUM <= MAX_PLASMA)
		{
			this.joules -= JOULES_PER_OPERATION;
			this.deuterium--;
	...
	public boolean isStackValidForSlot(int i, ItemStack itemstack)
	{
		if (itemstack != null)
		{
			switch(i)
			{
				case 0:	return itemstack.getItem() instanceof IItemElectric;
				case 1:	return itemstack.getItem() instanceof IAssembledTool;
				case 2:	return OreDictionary.getOres("cellDeuterium").contains(itemstack) || OreDictionary.getOres("cellTritium").contains(itemstack);
			}
		}
		return false;
	}
