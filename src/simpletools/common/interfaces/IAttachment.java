...
public interface IAttachment
{
	 ...
	 * @param i 		The ItemStack, to provide the metadata to the method.
	 * @param target	The target of the right click. There is no one safe cast, so check first.
	 * </br>			However, you can probably rely on it being an entity, or an Object[] { world, x, y, z, (int) side, hitX, hitY, hitZ }
	 * </br>			BUT IT CAN BE NULL!!!
	 * @param player	The player that used the item. Also, can be, and probably is, null. There are some time that it won't be though.
